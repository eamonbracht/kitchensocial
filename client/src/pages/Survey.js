  ...
  render() {
    ...
    return (
      <div>
        ...
        <div class="paper">
          <form
            onSubmit={() => this.putDataToDB(data)}
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <FormControlLabel
                  value="Maybe a few times"
                  control={<Radio />}
                  label="Maybe a few times"
                />
                <FormControlLabel
                  value="Pretty much everyday"
                  control={<Radio />}
                  label="Pretty much everyday"
                />
                >
              </RadioGroup>
            </FormControl>
            <FormControl component="fieldset" className={classes.formControl}>
              <FormLabel component="legend">
                How many times do you order delivery per week?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ delivery_per_week: e.target.value })
                }
              >
                <FormControlLabel
                  value="Almost never"
            ...
            >
              <FormLabel component="legend">
                How often do you buy your meal per week?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
            ...
            >
              <FormLabel component="legend">
                Which meal of the day do you eat most often from a restaurant?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ meal_of_day_restaurant: e.target.value })
                }
              >
                <FormControlLabel
                  value="bfast"
            ...
            <FormControl component="fieldset" className={classes.formControl}>
              <FormLabel component="legend">
                What kind of meals do you cook the most often at home?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ kind_meal_cooked_home: e.target.value })
                }
              >
                <FormControlLabel
                  value="bfast"
            ...
            <FormControl component="fieldset" className={classes.formControl}>
              <FormLabel component="legend">
                What is the number one reason you don’t cook at home as often as
                you would like to?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ reason_dont_cook: e.target.value })
                }
              >
                <FormControlLabel
                  value="grocery store/prep"
                  control={<Radio />}
                  label="Don’t have the time to grocery shop and prep"
                />
                <FormControlLabel
                  value="uncertain"
                  control={<Radio />}
                  label="Not sure how to/what to"
                />
                <FormControlLabel
                  value="convenient"
                  control={<Radio />}
                  label="Not convenient compared to eating out/ordering"
                />
                <FormControlLabel
                  value="clean-up"
                  control={<Radio />}
                  label="Don’t want to deal with clean-up afterwards"
                />
                <FormControlLabel
                  value="Other"
                  control={<Radio />}
            ...
            <FormControl fullWidth className={classes.FormControl}>
              <TextField
                ...
                margin="normal"
                onChange={e =>
                  this.setState({ reason_dont_cook_other: e.target.value })
                }
              />
            </FormControl>
            <FormControl fullWidth component="fieldset">
              <FormLabel component="legend">
                If you did not have to buy and prep ingredients and clean up
                afterwards, would you cook a lot more often?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ clean_ingred_cook_often: e.target.value })
                }
              >
                <FormControlLabel
                  value="yes"
            ...
            <FormControl fullWidth component="fieldset">
              <FormLabel component="legend">
                Would you feel more confident cooking if you had access to
                step-by-step videos?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ cook_with_videos: e.target.value })
                }
              >
                <FormControlLabel
                  value="yes"
                  control={<Radio />}
                  label="Yes, I would love that"
                />
                <FormControlLabel
                  value="no"
                  control={<Radio />}
                  label="I don’t really need them"
                />
                >
              </RadioGroup>
            </FormControl>
            <FormControl fullWidth component="fieldset">
              <FormLabel component="legend">
                How do you generally like to cook?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
                ...
                value={this.state.value}
                onChange={e =>
                  this.setState({ cooking_social: e.target.value })
                }
              >
                <FormControlLabel
                  value="alone"
            ...
            <FormControl component="fieldset" className={classes.formControl}>
              <FormLabel component="legend">
                How much do you spend on groceries everymonth?
              </FormLabel>
              <RadioGroup
                aria-label="Gender"
                name="gender1"
                ...
                onChange={e =>
                  this.setState({ spend_groceries: e.target.value })
                }
              >
