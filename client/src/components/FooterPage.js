        ...
        <Container className="mt-5 mb-4 text-center text-md-left">
          <Row className="mt-3">
            <Col md="3" lg="4" xl="3" className="mb-4 dark-grey-text">
              ...
              />
              <p>
              Redefine cooking as a social experience 
              that can be enjoyed without worry of inconvenience and inability.
              </p>
            </Col>
            ...
            <Col md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
              ...
              />
              <p>
                <i className="fa fa-home mr-3" /> Chicago, IL 60612, US
              </p>
              <p>
                <i className="fa fa-envelope mr-3" /> socialkitchinchi@gmail.com
              </p>
              {/* <p>
